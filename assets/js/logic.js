...
btn_toggle.addEventListener('click', () => {
    if (light) {
        ...
        btn_toggle.style = "background: url('./images/light.png') no-repeat;background-size: cover;";
        light = false;
    }
    else {
        document.body.style = 'background-color : white; color : black';
        btn_toggle.style = "background: url('./images/dark.png') no-repeat;;background-size: cover;";
        light = true;
    }
}
);
